...
void evaluate(vector<int> permut,vector<vector<double>> matrix, int n , int r)
{ 
...
void generatePermutation(int n, int r,vector<vector<double>> matrix)
{
    vector<int> permut(n);
    for(int i=0;i<n;i++)
    {
...
int main()
{
    ...
    generatePermutation( n, r,matrix);
}
